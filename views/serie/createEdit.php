    ...
    <body>
        ...
        <div class="container">
                ...
                if ($sendData) {
                    if (isset($_POST['itemTitle'])) {
                        ...
                        if (!empty($errorsEmptyFields) || !empty($errors)) {
                            ...
                            if (!$seriesEdited) {
                                AlertSystem::showError("La serie ya existe.". 
            ...
            <?php
                ...
                if ($action === 'create') {
                    if ($seriesCreated) {
                        AlertSystem::showSuccess('Serie creada correctamente.', 'list.php', 'Volver al listado de series');
                    }
                }
                if ($action === 'edit') {
                    if ($seriesEdited) {
                        AlertSystem::showSuccess('Serie editada correctamente.', 'list.php', 'Volver al listado de series');
                    }
                }
            }
            ?>

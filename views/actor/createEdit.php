    ...
    <div class="container">
        ...
        <?php
                ...
                if ($action === 'create' && $actorCreated) {
                     AlertSystem::showSucces('Actor creado exitosamente.', 'list.php', 'Volver al listado');
                } elseif ($action === 'edit' && $actorEdited) {
                     AlertSystem::showSucces('Actor editado exitosamente.', 'list.php', 'Volver al listado');
                }
            }
        ?>
    </div>
